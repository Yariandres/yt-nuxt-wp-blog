          ...
          <h1 class="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">
            Best practices for successful prototypes
				...
				<div class="flex flex-col gap-6">
					<p class="text-[22px] lead dark:text-gray-400">
					...
					<p class="text-[22px] dark:text-gray-400">
					...
					<figure>
						<img
							...
							alt=""
						/>
						<figcaption class="dark:text-gray-400">
							Digital art by Anonymous
						</figcaption>
					</figure>
					<h2 class="text-[32px] dark:text-white">Getting started with Flowbite</h2>
					<p class="text-[22px] dark:text-gray-400">
					...
					<h2 class="text-[32px] dark:text-white">When does design come in handy?</h2>
					<p class="text-[22px] dark:text-gray-400">
						While it might seem like extra work at a first glance, here are some
						key moments in which prototyping will come in handy:
					</p>
					<ol class="dark:text-gray-400 text-[22px]">
						<li>
							<strong class="dark:text-white">Usability testing</strong>. Does your user know how to exit
						...
						<li>
							<strong class="dark:text-white">Involving stakeholders</strong>. Need to check if your GDPR
							consent boxes are displaying properly? Pass your prototype to your
							data protection team and they can test it for real;
						</li>
						<li>
							<strong class="dark:text-white">Impressing a client</strong>. Prototypes can help explain or
							even sell your idea by providing your client with a hands-on
							experience;
						</li>
						<li>
							<strong class="dark:text-white">Communicating your vision</strong>. By using an interactive
							medium to preview and test design elements, designers and developers
							can understand each other — and the project — better.
						</li>
					</ol>
					<h3 class="text-[23px] dark:text-white">Laying the groundwork for best design</h3>
					<p class="text-[22px] dark:text-gray-400">
						Before going digital, you might benefit from scribbling down some
						ideas in a sketchbook. This way, you can think things through before
						committing to an actual design project.
					...
					<h3 class="text-[23px] dark:text-white">Understanding typography</h3>
					<h4 class="text-[20px] dark:text-white">Type properties</h4>
					<p class="text-[22px] dark:text-gray-400">
					...
					<h4 class="text-[20px] dark:text-white">Baseline</h4>
					<p class="text-[22px] dark:text-gray-400">
						A typeface is a collection of letters. While each letter is unique,
						certain shapes are shared across letters. A typeface represents shared
						patterns across a collection of letters.
					</p>
					<h4 class="text-[20px] dark:text-white">Measurement from the baseline</h4>
					<p class="text-[22px] dark:text-gray-400">
						A typeface is a collection of letters. While each letter is unique,
						certain shapes are shared across letters. A typeface represents shared
						patterns across a collection of letters.
					</p>
					<h3 class="text-[23px] dark:text-white">Type classification</h3>
					<h4 class="text-[20px] dark:text-white">Serif</h4>
					<p class="text-[22px] dark:text-gray-400">
					...
					<h4 class="text-[20px] dark:text-white">Old-Style serifs</h4>
					...
					<h3 class="text-[23px] dark:text-white">
					...
					<h4 class="text-[20px] dark:text-white">Code example</h4>
					<p class="text-[22px] dark:text-gray-400">
						A serif is a small shape or projection that appears at the beginning
						or end of a stroke on a letter. Typefaces with serifs are called serif
						typefaces. Serif fonts are classified as one of the following:
					...
					<h4 class="text-[20px] dark:text-white">Table example</h4>
					<p class="text-[22px] dark:text-gray-400">
						A serif is a small shape or projection that appears at the beginning
					...
					<p class="text-[22px] dark:text-gray-400">
						<strong class="dark:text-white">Low fidelity or high fidelity?</strong> Fidelity refers to how
					...
					<p class="text-[22px] dark:text-gray-400">
						<strong class="dark:text-white">Consider your user</strong>. To create an intuitive user flow,
					...
					<p class="text-[22px] dark:text-gray-400">
						<strong class="dark:text-white">Start from the inside out</strong>. A nice way to both
